...
pw = max([int((nw/8/2)*2),6])  # psi-width, number of flux surfaces around position of interest
...
# create rho_tor grid
psi_fine = np.linspace(psiax, psisep, nw*10)
...
#print('Z0          = {0}'.format(np.float(Zavg_spl(r))))
